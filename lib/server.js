...
exports.isProwler = function(email, cb) {
  client.sismember('prowler', email, function(err, data) {
    if (err) {
      console.log(err);
    } else {
      cb(null, data);
...
exports.isProwlerChannel = function(email, channel, cb) {
  var key = 'prowler:'.concat(email);
  client.sismember(key, channel, function(err, data) {
    if (err) {
      console.log(err);
    } else {
      cb(null, data);
...
exports.isKeywords = function(email, channel, keywords, cb) {
  var key = 'prowler:'.concat(email, ':', channel);
  client.sismember(key, keywords, function(err, data) {
    if (err) {
      console.log(err);
    } else {
      cb(null, data);
